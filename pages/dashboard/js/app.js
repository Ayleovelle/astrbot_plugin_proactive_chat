...
function App() {
  ...
  React.useEffect(() => {
    ...
    // Bridge 模式下降低轮询频率（5秒），避免 postMessage 通道拥塞超时。
    var isBridge = !!(window.AstrBotPluginPage && typeof window.AstrBotPluginPage.apiGet === "function");
    const interval = isBridge ? 5000 : 1000;
